...
function FallingBeer() {
  ...
  const size = 12 + Math.random() * 96; // taille aléatoire entre 12px et 108px
...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-b from-amber-50 to-orange-100 overflow-hidden">
      ...
      {/* Contenu centré */}
      <div className="flex flex-col items-center justify-center h-screen relative z-10 p-6">
        ...
        {voted && (
          <div className="mt-12 w-40 h-64 relative flex items-end justify-center">
            ...
            <p className="absolute -bottom-8 font-semibold">{translations[lang].glass}</p>
          </div>
        )}
      </div>
    </div>
